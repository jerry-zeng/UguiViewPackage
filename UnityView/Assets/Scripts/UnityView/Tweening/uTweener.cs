...
namespace UnityView.Tweening
{
    ...
    {
        static public uTweener current = null;


        public EaseType method = EaseType.linear;
        public LoopStyle style = LoopStyle.Once;
        ...
        void Update()
        {
            ...
            else if (style == LoopStyle.PingPong)
            {
            ...
            if ((style == LoopStyle.Once) && (duration == 0f || mFactor > 1f || mFactor < 0f))
            {
        ...
        public void Sample(float factor, bool isFinished)
        {
            ...
            val = (method == EaseType.none) ? animationCurve.Evaluate(val) : EaseHelper.EasingFromType(0, 1, val, method);
